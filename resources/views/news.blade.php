                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h4 class="mt-10">Patent 2023</h4>
                            @foreach($news as $data)
                            @if($data->title=="Patent 2023")
                            <p class="mt-10 mb-30 about-para"> {{$data->news}}
                            </p>
                            @endif
                            @endforeach

                            <h4 class="mt-10">Publications: 2023</h4>

                            <p class="mt-10 mb-30 about-para">
                            <ul class="student-list">
                                @foreach($news as $data)
                                @if($data->title=="Publications: 2023")
                                <li>{{$data->news}}
                                </li>
                                @endif
                                @endforeach
                            ...
                            @foreach($news as $data)
                            @if($data->title !== "Publications: 2023" && $data->title !== "Patent 2023")
                            <h4 class="mt-10">{{$data->title}}</h4>
                            <p class="mt-10 mb-30 about-para">
                            <ul class="student-list">
                                <li>{{$data->news}}
                                </li>
