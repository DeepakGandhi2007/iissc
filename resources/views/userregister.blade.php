        ...
        <div id="page" class="clearfix">
            ...
            <section>
                <div class="container mt-5 mb-5">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form method="post" class="comment-form form-submit" action="{{url('saveuser')}}"
                                ...
                                <div class="text-wrap clearfix">
                                    <fieldset class="name-wrap style-text">
                                        <input type="text" id="name" class="tb-my-input" name="name" tabindex="1"
                                            placeholder="Your Name" value="" aria-required="true" required="">
                                    </fieldset>
                                    <fieldset class="phone-wrap style-text">
                                        <input type="tel" id="phone" class="tb-my-input" name="phone" tabindex="1"
                                            placeholder="Phone Number" value="" aria-required="true" required="">
                                    </fieldset>
                                </div>
