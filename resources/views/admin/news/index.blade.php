                        ...
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span></span> <a class="btn btn-primary" href="{{url('admin/add-News')}}">Add
                                        News</a>
                                </li>
                            </ul>
                        </nav>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$i}}</td>
                                                <td>{{$data->title}}</td>
                                                <td style="width: 300px; text-wrap:wrap">{{$data->news}}</td>
                                                <td>
                                                    <a href="{{url('edit-news/'.$data->id)}}"><i
                                                            class="mdi mdi-table-edit"></i>Edit</a>
                                                    <a href="{{url('delete-news/'.$data->id)}}"><i
