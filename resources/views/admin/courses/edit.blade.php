                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-8 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form class="forms-sample" action="{{url('courses-update/'.$courses[0]->id)}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" required name="title" class="form-control"
                                                id="exampleInputEmail1" value="{{ $courses[0]->title }}"
                                                placeholder="Title">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Faculty</label>
                                            <input type="text" required name="Faculty"
                                                value="{{ $courses[0]->facuilty }}" class="form-control"
                                                id="exampleInput">
                                            <div class="form-group mt-2">
                                                <label for="exampleInputEmail1">Description</label>
                                                <textarea class="form-control summernote" name="Description"
                                                    id="summernote">{{ strip_tags($courses[0]->desc) }}</textarea>
                                            </div>
