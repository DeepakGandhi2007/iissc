                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">
                            ...
                            </span> Publications lists
                        </h3>
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span></span> <a class="btn btn-primary" href="{{url('admin/add-Publication')}}">Add
                                        Publications</a>
                                </li>
                            </ul>
                        </nav>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$i}}</td>
                                                <td style="width: 200px; text-wrap:wrap">{{$data->title}}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="{{url('edit-publication/'.$data->id)}}"><i
                                                            class="mdi mdi-table-edit"></i>Edit</a>
                                                    <a href="{{url('delete-publication/'.$data->id)}}"><i
