                        ...
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span></span> <a class="btn btn-primary" href="{{url('admin/add-Outreach')}}">Add
                                        Outreach</a>
                                </li>
                            </ul>
                        </nav>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            @php $i =0; @endphp
                                            @foreach($outreaches as $data)
                                            <tr>
                                                <td>{{$i}}</td>

                                                <td
                                                    style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 300px;">
                                                    {{ strip_tags($data->desc) }}</td>

                                                <td>
                                                    <a href="{{url('edit-outreaches/'.$data->id)}}"><i
