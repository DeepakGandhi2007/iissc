                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-title-heading">
                                <h1 class="heading">Researches</h1>
                                <ul class="text-color-2 breadcrumbs">
                                    <li><a href="{{url('/')}}">Home</a></li>
                                    <li class="action">Researches</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <h4 class="mt-10">{{$data->prof}}

                            </h4>
                            <h5 class="mt-10">{{$data->lab}}

                            </h5>
                            <p class="mt-10 mb-30 about-para"> {{ strip_tags($data->desc) }}
                            </p>
                            @endforeach
